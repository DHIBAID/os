...
void init_memory_management() {
	...
	static uint64_t pmm_metadata_storage[16384];
	// Initialize PMM
	pmm_init(total_memory, pmm_metadata_storage);
	...
	// Initialize VMM and enable core paging protections (WP/NX when supported).
	vmm_init();
}
